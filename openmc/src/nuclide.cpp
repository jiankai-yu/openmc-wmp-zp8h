  ...
  int i_sab, int i_log_union, double sab_frac, Particle& p)
{
  ...
  if (use_mp) {
    ...
    //if (name_=="B10") std::cout<<sig_c<<"\t"<<sig_a-sig_f<<std::endl;
	//if (name_=="U235") std::cout<<sig_c<<"\t"<<sig_a-sig_f<<std::endl;
	//if (name_=="U235" && p.E()<=1e-4) std::cout<<sig_c<<"\t"<<sig_f<<std::endl;
	//if (name_=="B11") std::cout<<sig_c<<"\t"<<sig_a-sig_f<<std::endl;
	...
	micro.capture = 0.0; // only used in wmp based multipole 
